...
namespace DB_Form.logintestDataSetTableAdapters {
...
SELECT [Emp-ID], UserName, Role FROM Data WHERE ([Emp-ID] = @Emp_ID)";
        ...
        public virtual int Fill(logintestDataSet.DataDataTable dataTable) {
        ...
        public virtual logintestDataSet.DataDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            logintestDataSet.DataDataTable dataTable = new logintestDataSet.DataDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(logintestDataSet.DataDataTable dataTable) {
